    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.description}>
          ...
          <p>Like all things at the foundation, this philosophy is a work in progress and will be refined with input from the community. Would you want to <a href="https://github.com/chtnnhfndn/chtnnhfoundation.org">contribute</a>?</p>
        </div>
      </main>
